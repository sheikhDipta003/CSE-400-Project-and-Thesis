...
def create_iam_user(user_name):
    try:
        ...
        if e.response['Error']['Code'] == 'EntityAlreadyExists':
            ...
            return False
    return response
# responseObject = create_iam_user("DiptaSimpleTest1")
...
def update_iam_user(existing_user_name, new_user_name):
    try:
        ...
        if e.response['Error']['Code'] == 'EntityAlreadyExists':
            ...
            print("Unexpected error: %s" % e)
# update_iam_user("DiptaTest1", "DiptaTest1Renamed")
# list_iam_users()
...
def delete_iam_user(existing_user_name):
    try:
        ...
        if e.response['Error']['Code'] == 'EntityAlreadyExists':
            ...
            print("Unexpected error: %s" % e)
# delete_iam_user("DiptaTest1Renamed")
# list_iam_users()
...
#create_iam_policy("test_policy_1_by_Dipta", custom_policy_json)
...
# create_iam_user("Dipta_poilcy_test_user_1")
# attach_custom_iam_policy_with_user("test_policy_1_by_Dipta", "Dipta_poilcy_test_user_1")
...
def attach_managed_iam_policy_with_user(policy_name, user_name):
    try:
        ...
        if e.response['Error']['Code'] == 'EntityAlreadyExists':
            ...
            print("Unexpected error: %s" % e)
# attach_managed_iam_policy_with_user("AdministratorAccess", "Dipta_poilcy_test_user_1")
...
#detach_custom_iam_policy_with_user("test_policy_1_by_Dipta","Dipta_poilcy_test_user_1")
...
#detach_managed_iam_policy_with_user("AdministratorAccess", "Dipta_poilcy_test_user_1")
